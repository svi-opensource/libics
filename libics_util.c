...
void IcsInit(Ics_Header *icsStruct)
{
    ...
    icsStruct->refrInxMediumStatus = IcsSensorStatus_default;
    icsStruct->numAperture = 0.0;
    icsStruct->numApertureStatus = IcsSensorStatus_default;
    icsStruct->refrInxLensMedium = 0.0;
    icsStruct->refrInxLensMediumStatus = IcsSensorStatus_default;
    icsStruct->pinholeSpacing = 0.0;
    icsStruct->pinholeSpacingStatus = IcsSensorStatus_default;
    icsStruct->sensorChannels = 0;
    for (i = 0; i < ICS_MAX_LAMBDA; i++) {
        icsStruct->type[i][0] = '\0';
        icsStruct->pinholeRadius[i] = 0.0;
        icsStruct->pinholeRadiusStatus[i] = IcsSensorStatus_default;
        icsStruct->lambdaEx[i] = 0.0;
        icsStruct->lambdaExStatus[i] = IcsSensorStatus_default;
        icsStruct->lambdaEm[i] = 0.0;
        icsStruct->lambdaEmStatus[i] = IcsSensorStatus_default;
        icsStruct->exPhotonCnt[i] = 1;
        icsStruct->exPhotonCntStatus[i] = IcsSensorStatus_default;
        icsStruct->stedDepletionMode[i][0] = '\0';
        icsStruct->stedDepletionModeStatus[i] = IcsSensorStatus_default;
        icsStruct->stedLambda[i] = 0.0;
        icsStruct->stedLambdaStatus[i] = IcsSensorStatus_default;
        icsStruct->stedSatFactor[i] = 0.0;
        icsStruct->stedSatFactorStatus[i] = IcsSensorStatus_default;
        icsStruct->stedImmFraction[i] = 0.0;
        icsStruct->stedImmFractionStatus[i] = IcsSensorStatus_default;
        icsStruct->stedVPPM[i] = 0.0;
        icsStruct->stedVPPMStatus[i] = IcsSensorStatus_default;
        icsStruct->detectorPPU[i] = 1.0;
        icsStruct->detectorPPUStatus[i] = IcsSensorStatus_default;
        icsStruct->detectorBaseline[i] = 0.0;
        icsStruct->detectorBaselineStatus[i] = IcsSensorStatus_default;
        icsStruct->detectorLineAvgCnt[i] = 1.0;
        icsStruct->detectorLineAvgCntStatus[i] = IcsSensorStatus_default;
    }
